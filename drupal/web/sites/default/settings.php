 ...
 * @endcode
 */
$settings['hash_salt'] = 'naAbG8ig4HebD_sT8usshAKQUNaYr8SNQJ_3rCn2lC2fmFHff5TFFUm_KI-ajgyyGEmZy4uKww';
 ...
 */
$file_private_path = getenv('DRUPAL_PRIVATE_FILE_SYSTEM');
$settings['file_private_path'] =  $file_private_path ? $file_private_path : '../private';
...
$env = getenv('APP_ENV');
if ($env && file_exists($app_root . '/' . $site_path . '/settings.' . $env . '.php')) {
